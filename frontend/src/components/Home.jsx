    ...
    <div className="bg-gradient-to-r from-black to-blue-950 ">
      <div className="h-screen text-white container mx-auto">
        ...
        <section className="text-center py-20">
          ...
          <br />
          <br />
          <p className="text-gray-500">Upgrade Your Skills, Unlock Your Future</p>
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="mt-3 ml=2 md:ml-8">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="">
                    <FaInstagram className="text-2xl hover:text-pink-600 duration-300" /></a>
                  <a href="">
                    <FaTwitter className="text-2xl hover:text-blue-600 duration-300" /></a>
                </div>
              </div>
            </div>
